...
NSString *const AWSS3SDKVersion = @"2.28.0";
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        AWSSignatureV4Signer *signer = [[AWSSignatureV4Signer alloc] initWithCredentialsProvider:_configuration.credentialsProvider
                                                                         ...
                                                                         chunkedEncodingDisabled:_configuration.chunkedEncodingDisabled];
...
- (AWSTask *)invokeRequest:(AWSRequest *)request
    ...
    @autoreleasepool {
		...
		networkingRequest.requestSerializer = [[AWSS3RequestSerializer alloc] initWithJSONDefinition:[[AWSS3Resources sharedInstance] JSONObject]
                                                                                  ...
                                                                                  enablePathStyleAccess:self.configuration.pathStyleAccessEnabled];
