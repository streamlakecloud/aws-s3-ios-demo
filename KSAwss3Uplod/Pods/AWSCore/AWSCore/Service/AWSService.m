...
NSString *const AWSiOSSDKVersion = @"2.28.0";
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    configuration.pathStyleAccessEnabled = self.pathStyleAccessEnabled;
    configuration.chunkedEncodingDisabled = self.chunkedEncodingDisabled;
...
static NSString *const AWSRegionNameCNNorth1 = @"kos-cn-beijing"; // StreamLake S3 BJ Region
