...
- (void)applyUpload {
    ...
    NSDictionary *headers = [RequestSignature signaturesWithHostString:@"https://vod.streamlakeapi.com" andActionString:@"ApplyUploadInfo" paramString:parameters.mj_JSONString secretId:@"YOUR_ACCESS_KEY" secretKey:@"YOUR_SECRET_KEY" deployVersion:@"0.0.1" contentType:@"application/json"];
...
- (void)commitUpload {
    ...
    NSDictionary *headers = [RequestSignature signaturesWithHostString:@"https://vod.streamlakeapi.com" andActionString:@"CommitUpload" paramString:parameters.mj_JSONString secretId:@"YOUR_ACCESS_KEY" secretKey:@"YOUR_SECRET_KEY" deployVersion:@"0.0.1" contentType:@"application/json"];
